# Generated by Django 2.2.5 on 2019-09-26 22:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.IntegerField(choices=[(0, 'General'), (1, 'Donante'), (2, 'Voluntario'), (3, 'Ambos')], default=0, verbose_name='Tipo de Contacto')),
                ('email', models.EmailField(blank=True, default=None, max_length=254, null=True)),
                ('sexo', models.IntegerField(blank=True, choices=[(0, 'Hombre'), (1, 'Mujer'), (2, 'No Aplica')], default=None, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('turno', models.IntegerField(blank=True, choices=[(0, 'Mañana'), (1, 'Tarde')], default=0, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_de_compromiso', models.DateTimeField(verbose_name='fecha de compromiso')),
                ('contacto', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='crm.Contacto')),
            ],
        ),
        migrations.CreateModel(
