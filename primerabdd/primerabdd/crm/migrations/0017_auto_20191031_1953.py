...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='contacto',
            name='categoria',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='crm.CampoCustomTipoContacto'),
        ),
        migrations.AlterField(
            model_name='contacto',
            name='origen',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='crm.CampoCustomOrigen'),
        ),
        migrations.AlterField(
            model_name='contacto',
            name='sexo',
            field=models.IntegerField(choices=[(0, 'Masculino'), (1, 'Femenino'), (2, 'Otro')], default=2),
        ),
        migrations.AlterField(
            model_name='cuenta',
            name='tipo',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='crm.CampoCustomTipoCuenta'),
        ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm.CampoCustomEstadoOportunidad'),
        ),
        migrations.AddField(
            model_name='oportunidad',
            name='tipo',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm.CampoCustomTipoOportunidad'),
        ),
    ]
