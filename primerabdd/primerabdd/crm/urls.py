...
urlpatterns = [
    ...
    path('create/<int:cuentaAsociada>', views.ContactoCrear.as_view(), name='crear_contacto'),
    ...
    path('download/oportunidades/csv/', views.download_oportunidades_csv, name='download_oportunidades_csv'), 
    path('download/cuentas/csv/', views.download_cuentas_csv, name='download_cuentas_csv'),    
    ...
    path('custom/createOportunityState/', views.CampoCustomEstadoOportunidadCrear.as_view(), name='crear_custom_estado_oportunidad'),
    path('custom/editOportunityState/<int:pk>', views.CampoCustomEstadoOportunidadEditar.as_view(), name='editar_custom_estado_oportunidad'),
    path('custom/deleteOportunityState/<int:pk>', views.CampoCustomEstadoOportunidadEliminar.as_view(), name='eliminar_custom_estado_oportunidad'),
    path('custom/createOportunityType/', views.CampoCustomTipoOportunidadCrear.as_view(), name='crear_custom_tipo_oportunidad'),
    path('custom/editOportunityType/<int:pk>', views.CampoCustomTipoOportunidadEditar.as_view(), name='editar_custom_tipo_oportunidad'),
    path('custom/deleteOportunityType/<int:pk>', views.CampoCustomTipoOportunidadEliminar.as_view(), name='eliminar_custom_tipo_oportunidad'),
    ...
    path('oportunidades/<int:pk>', views.OportunidadesDetalles.as_view(), name='oportunidades_detalles'),
]